...
},
{
  "id": "example-1",
  "level": "2",
  "url": "sec-first-examples.html#example-1",
  "type": "Example",
  "number": "1.2.1",
  "title": "",
...
},
{
  "id": "example-2",
  "level": "2",
  "url": "sec-first-examples.html#example-2",
  "type": "Example",
  "number": "1.2.2",
  "title": "",
...
},
{
  "id": "example-3",
  "level": "2",
  "url": "sec-features-blocks.html#example-3",
  "type": "Example",
  "number": "3.1.2",
  "title": "",
...
},
{
  "id": "figure-1",
  "level": "2",
  "url": "sec-features-blocks.html#figure-1",
  "type": "Figure",
  "number": "3.1.3",
  "title": "",
...
},
{
  ...
  "body": " Image Examples   The graph made by TikZ   A 5-cycle?      The graph made by TikZ   A 5-cycle!        "
},
{
  "id": "fig-tikz",
  "level": "2",
  "url": "section-4.html#fig-tikz",
  "type": "Figure",
  "number": "4.1.1",
  "title": "",
...
},
{
  ...
  "body": " WeBWorK Example    For your college interview, you must wear a tie. You own 4 regular (boring) ties and 2 (cool) bow ties.   How many choices do you have for your neck-wear?    You realize that the interview is for clown college, so you should probably wear both a regular tie and a bow tie. How many choices do you have now?    For the rest of your outfit, you have 2 shirts, 4 skirts, 8 pants, and 6 dresses. You want to select either a shirt to wear with a skirt or pants, or just a dress. How many outfits do you have to choose from?                      ties. Use the additive principle.    ties. Use the multiplicative principle    outfits.           Compute the sum of and     Add and together.              "
},
{
  "id": "Abr",
  "level": "2",
  "url": "webwork.html#Abr",
  "type": "Checkpoint",
  "number": "4.2.1",
  "title": "",
  "body": "  For your college interview, you must wear a tie. You own 4 regular (boring) ties and 2 (cool) bow ties.   How many choices do you have for your neck-wear?    You realize that the interview is for clown college, so you should probably wear both a regular tie and a bow tie. How many choices do you have now?    For the rest of your outfit, you have 2 shirts, 4 skirts, 8 pants, and 6 dresses. You want to select either a shirt to wear with a skirt or pants, or just a dress. How many outfits do you have to choose from?                      ties. Use the additive principle.    ties. Use the multiplicative principle    outfits.        "
},
{
  "id": "exercise-4",
  "level": "2",
  "url": "webwork.html#exercise-4",
  "type": "Checkpoint",
  "number": "4.2.2",
  "title": "",
...
},
{
  "id": "sieve-python",
  "level": "2",
  "url": "codelens.html#sieve-python",
  "type": "Listing",
  "number": "4.5.1",
  "title": "",
